...
def tex_pic(n):
    ...
    plt.savefig('%s/lenamdexpvv10asmdmultipkl%s.png' % (texdir,n))
    plt.savefig('%s/lenamdexpvv10asmdmultipkl%s.eps' % (texdir,n))
def continue_pic():
    plt.savefig('lenamdexpvv10asmdmultipkl.png') # % (texdir,n))
    plt.savefig('lenamdexpvv10asmdmultipkl.eps') # % (texdir,n))
