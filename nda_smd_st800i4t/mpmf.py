...
def tex_pic(n):
    ...
    plt.savefig('%s/danamdexpvv10asmdmultipkl%s.png' % (texdir,n))
    plt.savefig('%s/danamdexpvv10asmdmultipkl%s.eps' % (texdir,n))
def continue_pic():
    plt.savefig('danamdexpvv10asmdmultipkl.png') # % (texdir,n))
    plt.savefig('danamdexpvv10asmdmultipkl.eps') # % (texdir,n))
