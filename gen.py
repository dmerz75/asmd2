...
environ=['02.imp']#'01.vac','02.imp','03.exp']       # ['01.vac'] | ['01.vac','03.exp']
...
gate ='fgatecpu2'   # namd                 # ggategpu,ggatecpu,fgatecpu,steele
                                           # steele2,fgatecpu2,ggatecpu2/gpu2
                    # amb                  # multisndr2,fgatecpu2
cn   ='3'                                  # ppn request
ppn_env={'01.vac':'1','02.imp':'3','03.exp':cn}
...
dircounts=['5']    # ['1','2'], jobid=12
jobid=('').join(dircounts)+'_st'+str(len(path_seg))+'_r00' # <<<~~~~~!!!
