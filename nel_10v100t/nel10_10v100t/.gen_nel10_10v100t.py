...
molec  =[mlist[4]]                         # can use [0],[1] ... [n]
zcrd   = 18.0                              # z constraint:  13,33,4, start pos.
envdist={'01.vac':zcrd,'02.imp':zcrd,'03.exp':zcrd} # i.e. '01.vac':zc7...
dist   = 140.0                              # declare a float dist:20.0,32.0
ts     = 2.0                               # 0.5, 1.0, 2.0
n      =[2.,3.]                            # [1.,2.] | [4.,5.]
...
path_seg =np.linspace(0.05,0.05,20)
path_svel=np.linspace(1.0,1.0,20)
...
setup  ={1:{'howmany':100,'freq':50},
         2:{'howmany':10,'freq':50},    # 45*18t = 810, 29*28t = 812,
         3:{'howmany':10,'freq':50},    # 20*40t = 800, 25*32t = 800
         4:{'howmany':2,'freq':50},
         5:{'howmany':1,'freq':50}}
# --> FINISH HERE     # total trajectories = dircount*setup[n]['howmany']
dircounts=['10']    # ['1','2'], jobid=12
jobid=('').join(dircounts)+'v100t' # <<<~~~~~!!!
