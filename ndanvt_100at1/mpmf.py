...
def tex_pic(n):
    ...
    plt.savefig('%s/danvtnamdexpvv1asmdmultipkl%s.png' % (texdir,n))
    plt.savefig('%s/danvtnamdexpvv1asmdmultipkl%s.eps' % (texdir,n))
def continue_pic():
    plt.savefig('danvtnamdexpvv1asmdmultipkl.png') # % (texdir,n))
    plt.savefig('danvtnamdexpvv1asmdmultipkl.eps') # % (texdir,n))
