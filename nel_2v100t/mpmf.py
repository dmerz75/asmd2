...
def tex_pic(n):
    ...
    plt.savefig('%s/elnamdvacvv10asmdmultipkl%s.png' % (texdir,n))
    plt.savefig('%s/elnamdvacvv10asmdmultipkl%s.eps' % (texdir,n))
def continue_pic():
    plt.savefig('elnamdvacvv10asmdmultipkl.png') # % (texdir,n))
    plt.savefig('elnamdvacvv10asmdmultipkl.eps') # % (texdir,n))
